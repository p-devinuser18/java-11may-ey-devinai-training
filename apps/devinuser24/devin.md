# devinuser24 — scoped conventions

This folder is owned by **devinuser24**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser24/<short-feature-name>
- PR base: devinuser24/integration (NOT main)
