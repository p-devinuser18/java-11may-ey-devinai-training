# devinuser1 — scoped conventions

This folder is owned by **devinuser1**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser1/<short-feature-name>
- PR base: devinuser1/integration (NOT main)
