# devinuser5 — scoped conventions

This folder is owned by **devinuser5**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser5/<short-feature-name>
- PR base: devinuser5/integration (NOT main)
