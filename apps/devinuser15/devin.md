# devinuser15 — scoped conventions

This folder is owned by **devinuser15**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser15/<short-feature-name>
- PR base: devinuser15/integration (NOT main)
