# devinuser22 — scoped conventions

This folder is owned by **devinuser22**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser22/<short-feature-name>
- PR base: devinuser22/integration (NOT main)
