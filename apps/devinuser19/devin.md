# devinuser19 — scoped conventions

This folder is owned by **devinuser19**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser19/<short-feature-name>
- PR base: devinuser19/integration (NOT main)
