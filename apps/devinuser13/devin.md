# devinuser13 — scoped conventions

This folder is owned by **devinuser13**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser13/<short-feature-name>
- PR base: devinuser13/integration (NOT main)
