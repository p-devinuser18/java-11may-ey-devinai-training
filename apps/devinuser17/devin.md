# devinuser17 — scoped conventions

This folder is owned by **devinuser17**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser17/<short-feature-name>
- PR base: devinuser17/integration (NOT main)
