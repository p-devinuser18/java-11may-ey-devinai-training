# devinuser10 — scoped conventions

This folder is owned by **devinuser10**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser10/<short-feature-name>
- PR base: devinuser10/integration (NOT main)
