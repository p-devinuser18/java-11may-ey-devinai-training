# devinuser11 — scoped conventions

This folder is owned by **devinuser11**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser11/<short-feature-name>
- PR base: devinuser11/integration (NOT main)
