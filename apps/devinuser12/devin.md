# devinuser12 — scoped conventions

This folder is owned by **devinuser12**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser12/<short-feature-name>
- PR base: devinuser12/integration (NOT main)
