# devinuser7 — scoped conventions

This folder is owned by **devinuser7**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser7/<short-feature-name>
- PR base: devinuser7/integration (NOT main)
