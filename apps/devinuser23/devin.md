# devinuser23 — scoped conventions

This folder is owned by **devinuser23**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser23/<short-feature-name>
- PR base: devinuser23/integration (NOT main)
