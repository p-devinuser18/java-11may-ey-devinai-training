# devinuser18 — scoped conventions

This folder is owned by **devinuser18**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser18/<short-feature-name>
- PR base: devinuser18/integration (NOT main)
