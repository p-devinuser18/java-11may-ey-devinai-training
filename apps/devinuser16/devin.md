# devinuser16 — scoped conventions

This folder is owned by **devinuser16**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser16/<short-feature-name>
- PR base: devinuser16/integration (NOT main)
