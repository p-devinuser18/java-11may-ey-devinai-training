# devinuser14 — scoped conventions

This folder is owned by **devinuser14**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser14/<short-feature-name>
- PR base: devinuser14/integration (NOT main)
