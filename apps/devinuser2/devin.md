# devinuser2 — scoped conventions

This folder is owned by **devinuser2**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser2/<short-feature-name>
- PR base: devinuser2/integration (NOT main)
