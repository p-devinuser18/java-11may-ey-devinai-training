# devinuser4 — scoped conventions

This folder is owned by **devinuser4**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser4/<short-feature-name>
- PR base: devinuser4/integration (NOT main)
