# devinuser6 — scoped conventions

This folder is owned by **devinuser6**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser6/<short-feature-name>
- PR base: devinuser6/integration (NOT main)
