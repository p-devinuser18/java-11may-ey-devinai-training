# devinuser21 — scoped conventions

This folder is owned by **devinuser21**. Devin sessions for this participant
...
## Branch convention
- Feature branches: devinuser21/<short-feature-name>
- PR base: devinuser21/integration (NOT main)
